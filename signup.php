    ...
    <div class="login">
        <form action="actsignup.php" method="POST">
            ...
            <div class="mb-3">
                ...
                <div id="emailHelp" class="form-text">Не передадим в чужие руки адрес вашей почты.</div>
            </div>
            ...
            <div class="mb-3">
                <label for="exampleInputPassword1" class="form-label">Желаемая специализация</label>
                <input name="profession" type="text" class="form-control" id="exampleInputPassword1">
            </div>
